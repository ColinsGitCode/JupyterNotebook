...
def sms_dataset(splitRatio = 0.67):
    print("---------------Start-----------------------------")
    print("SNS dataset with full-format bag-of-words vectors")
    ...
    csvFileName = "XUE_sms_fullFormat.csv"
...
def sms_dataset_sparseFormat(splitRatio = 0.67):
    print("---------------Start-----------------------------")
    print("SMS dataset with sparse-format bag-of-words vectors")
    ...
    csvFileName = "XUE_sms_sparseFormat.csv"
    write_result_in_csv(testPredictions,csvFileName)
    print("---------------END-----------------------------")
...
def net_dataset_sparseFormat(splitRatio = 0.67):
    print("---------------Start-----------------------------")
    print("NET dataset with sparse-format bag-of-words vectors")
    ...
    csvFileName = "XUE_net_sparseFormat.csv"
    write_result_in_csv(testPredictions,csvFileName)
    print("---------------END-----------------------------")
...
def net_dataset(splitRatio = 0.67):
    print("---------------Start-----------------------------")
    print("NET dataset with full-format bag-of-words vectors")
    trainLine, trainDict = read_net_file_return_lines_and_dictionary("net_train.csv")
    print("The train lines acount is: %d" %len(trainLine))
    print("The train dictionary words acount is: %d" %len(trainDict))
    ...
    csvFileName = "XUE_net_fullFormat.csv"
    write_result_in_csv(testPredictions,csvFileName)
    print("---------------END-----------------------------")
